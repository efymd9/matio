...
export default defineConfig({
  ...
  test: {
    coverage: {
      ...
      // → 31.3 (#162: ретеншен — lib/retention.ts и /api/cron/retention
      //   покрыты целиком, плюс кейс лог-аудита и открытый путь крона в
      //   замке стенда; 31.41/25.9/25.99/31.06 по прогону поверх свежего
      //   main (af6d6dd, TS 6 влит), те же 0.1 запаса).
      thresholds: {
        lines: 31.3,
        functions: 25.8,
        branches: 25.8,
