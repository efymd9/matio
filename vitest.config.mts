...
export default defineConfig({
  ...
  test: {
    coverage: {
      ...
      // → 31.4 (#183: CAPI-снимок и стирание метаданных Stripe).
      // → 34.4 (#144: плеер ветвления — правила кандидатов/нумерации в
      //   lib/branching.ts, семь jsdom-сценариев развилки в player.test.tsx
      //   (промпт, выбор, таймаут, тихая реконвергенция, концовка, Lead,
      //   список), оверлей выбора и пять Lab-вариантов исполняются
      //   историями, рельс продолжения через незавершённую ветку;
      //   34.56/29.40/29.20/34.31 по прогону поверх свежего main (#183
      //   влит), те же 0.1 запаса).
      thresholds: {
        lines: 34.4,
        functions: 29.3,
