...
export default defineConfig({
  ...
  test: {
    coverage: {
      ...
      // → __L__ (#144: плеер ветвления — правила кандидатов/нумерации в
      ...
      //   незавершённую ветку; __MEASURED__ по прогону поверх свежего main
      //   (#162 влит), то же правило «max(main, локальный − 0.7)»).
      thresholds: {
        lines: 32.1,
        functions: 26.5,
        branches: 26.8,
