...
export default defineConfig({
  ...
  test: {
    coverage: {
      ...
      // → 33.5 (#163: экспорт данных субъекта — lib/user-export.ts,
      //   lib/user-export-db.ts и вынесенный HogQL-транспорт покрыты
      //   целиком, лог-аудит +2 кейса; 34.20/28.53/28.56/33.80 по прогону
      //   поверх слитого main (a47e8a5d, #186/#191 влиты) после правок
      //   ревью. То же правило «max(main, локальный − 0.7)»; поднять до
