...
components/
  ...
  site/                    # header, footer, cookie-banner, language switcher,
                           ...
                           #   (ChatGPT Ads subscription_created on checkout
                           #   return — paid mode),
